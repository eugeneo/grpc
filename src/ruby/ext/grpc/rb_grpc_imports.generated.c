...
grpc_dump_xds_config_type grpc_dump_xds_config_import;
...
void grpc_rb_load_imports(HMODULE library) {
  ...
  grpc_dump_xds_config_import = (grpc_dump_xds_config_type) GetProcAddress(library, "grpc_dump_xds_config");
