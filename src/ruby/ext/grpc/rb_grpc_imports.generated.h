...
typedef grpc_slice(*grpc_dump_xds_config_type)(void);
extern grpc_dump_xds_config_type grpc_dump_xds_config_import;
#define grpc_dump_xds_config grpc_dump_xds_config_import
