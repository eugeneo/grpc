...
typedef grpc_server_config_fetcher*(*grpc_server_config_fetcher_xds_create_type)(const char* xds_client_key, grpc_server_xds_status_notifier notifier, const grpc_channel_args* args);
